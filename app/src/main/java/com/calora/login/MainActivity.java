...
public class MainActivity extends Activity {
    ...
    public final void TryLoginPHP() {
        ...
        GradientDrawable gd = new GradientDrawable(Orientation.TOP_BOTTOM, new int[]{-16711680, -2550000, -16711680});
        ...
        newMod.setText(Team());
        newMod.setTextSize(30.0f);
        newMod.setTextColor(-1);
        newMod.setGravity(17);
        newMod.setPadding(0, 0, 0, 10);
        newMod.setBackgroundColor(0);
        main.addView(newMod);
        this.prefs = Prefs.with(this);
		TextView usernamecl = new TextView(this);
		usernamecl.setText("Usuario");
        usernamecl.setTextSize(15.0f);
		usernamecl.setTextColor(-1);
		main.addView(usernamecl);
        String sUser = "";
		...
		TextView passwordcl = new TextView(this);
		passwordcl.setText("Contraseña");
        passwordcl.setTextSize(15.0f);
		passwordcl.setTextColor(-1);
		main.addView(passwordcl);
        ...
        TextView init = new TextView(this);
